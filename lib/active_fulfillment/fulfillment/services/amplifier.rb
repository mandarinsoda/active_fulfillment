...
module ActiveMerchant
  module Fulfillment
    class AmplifierService < Service
     ...
     TEST_URLS = SERVICE_URLS.merge({
                       :fulfillment => 'http://api-test.amplifier.com/Yahoo/Orders.aspx',
                       :inventory => 'http://api-i-test.amplifier.com/Services/Yahoo/Inventory.aspx'
                     })
      ...
      def self.shipping_methods
        ...
        ['UPS Next Day Air', 'UPS Next Day Air']].inject(ActiveSupport::OrderedHash.new){|h, (k,v)| h[k] = v; h}
      end
